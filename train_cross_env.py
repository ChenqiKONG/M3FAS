...
def parse_args():
    ...
    # Please change the setting, device, and env factor for cross-environment implementations (distance, noise, headpose)
    parser.add_argument('--save_root', default='./Training_results/Cross_headpose_fusion/setting3/', type=str)
    parser.add_argument('--root_path', default='./', type=str)
    parser.add_argument('--model_name', default="note", type=str)

    parser.add_argument('--train_csv', default="./csv/Cross_headpose_csv/note/setting3/train.csv", type=str)
    parser.add_argument('--val_csv', default="./csv/Cross_headpose_csv/note/setting3/val.csv", type=str)
    parser.add_argument('--test_csv', default="./csv/Cross_headpose_csv/note/setting3/test.csv", type=str)
